                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="/jobs/create" :active="request()->is('jobs.create')">Create Form</x-nav-link>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full" src="https://https://laracasts.com/images/lary-ai-face.svg" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base font-medium leading-none text-white">Dennis</div>
                        <div class="text-sm font-medium leading-none text-gray-400">triaxxin29@gmail.com</div>
                    </div>
